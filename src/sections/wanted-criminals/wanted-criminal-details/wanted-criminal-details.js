  ...
  return (
    ...
    >
      <Grid p={0} pr={2} sx={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
        <Avatar shape="square" size={256} src={wantedCriminal.avatarLink} />
          ...
          >
            {[
              ...
              <Descriptions.Item label={field.label} span={field.span} key={field.name}>
                {field.selectProps
                  ? field.selectProps[wantedCriminal[field.name]]
                  : wantedCriminal[field.name]}
              </Descriptions.Item>
            ))}
          </Descriptions>
        </Grid>
        <Grid p={0} mt={1}>
          ...
          >
            {[
              ...
              <Descriptions.Item label={field.label} span={field.span} key={field.name}>
                {wantedCriminal &&
                wantedCriminal.wantedCriminals &&
                wantedCriminal.wantedCriminals.length
                  ? field.selectProps
